...
function pkcs1pad2(s,n){if(n<s.length+11){return null;}
...
RSAKey.prototype.doPublic=RSADoPublic;RSAKey.prototype.setPublic=RSASetPublic;RSAKey.prototype.encrypt=RSAEncrypt;function Arcfour(){this.i=0;this.j=0;this.S=new Array();}
...
SecureRandom.prototype.nextBytes=rng_get_bytes;function createRSA(securityPublicModules,securityPublicExponent){var rsa=new RSAKey();rsa.setPublic(securityPublicModules,securityPublicExponent);return rsa;}